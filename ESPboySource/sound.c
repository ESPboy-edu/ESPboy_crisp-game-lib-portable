...
#define MAX_SOUND_EFFECT_NOTE_LENGTH 16//32
...
static PROGMEM int nextChordsIndex[][3] = {
    {0, 1, 2},
    {1, 2, 0},
    {2, 0, 0},
};

static PROGMEM int keys[7] = {0, 2, 3, 5, 7, 9, 10};
static PROGMEM int progression[2][4] = {{0, 4, 7, 11}, {0, 3, 7, 10}};
